...
//   ?status=open|confirmed|contested|dismissed|resolved|archived|pinned|all (default open)
//   ?domain=energy|mood|focus|time|decisions|relationships|work|habits|money|mixed
